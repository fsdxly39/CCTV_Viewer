                        ...
                        """
                                     ...
                                     function AutoFullscreen() {
                                         ...
                                         var selectors = [
                                             ...
                                             '.videoFull', // 通用类名
                                             '.txp_btn_fullscreen', // 腾讯视频/央视频
                                             '.vjs-fullscreen-control', // Video.js (广东、广西、河南等)
                                             '.m-player-fullscreen', // 芒果TV
                                             '.fullscreen-btn', // 深圳卫视等通用
                                             '[title="全屏"]', // 通用属性
                                             '[aria-label="全屏"]', // 通用无障碍属性
                                             '.prism-fullscreen-btn', // 阿里播放器
                                             '.jw-icon-fullscreen', // JW Player
                                             '.ytp-fullscreen-button' // YouTube类播放器
                                         ];
                                         ...
                                         for (var i = 0; i < selectors.length; i++) {
                                             ...
                                             if (btn) {
                                                 ...
                                                 clicked = true;
                                                 console.log('AutoFullscreen: Clicked ' + selectors[i]);
                                                 break; // 找到并点击后退出循环
                                             }
                                         }
                    ...
                    switch (menuOverlaySelectedIndex) {
                        ...
                        case 2:
                            ...
                            String script1 = """
                                    ...
                                    // 尝试查找并点击全屏按钮
                                    var selectors = [
                                        '#player_pagefullscreen_yes_player', '.videoFull', '.txp_btn_fullscreen',
                                        '.vjs-fullscreen-control', '.m-player-fullscreen', '.fullscreen-btn',
                                        '[title="全屏"]', '[aria-label="全屏"]'
                                    ];
                                    for (var i = 0; i < selectors.length; i++) {
                                        var btn = document.querySelector(selectors[i]);
